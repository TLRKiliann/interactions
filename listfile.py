...
oneDrug=["atarax", "demetrin", "prazépam", "briviact", "brivaracétam", "abilify", 
      ...
      "dogmatil", "sulpride", "invega", "palipéridone", "olanzapine", "zyprexa", 
      "risperdal", "risperdone", "seroquel", "sequase", "quétiapine", "solian", 
      "amisulpride", "ethosuximide", "pétinimid", "mysoline", "primidone", "phénobarbital", 
      "aphénylbarbite", "phénytoïne", "fycompa", "pérampanel", "inovelon", "rufinamide", 
      "keppra", "levetiracetam", "lamictal", "lamotrigine", "lyrica", "prégabaline", 
      "neurontin", "gabapentine", "sabril", "vigabatrin", "taloxa", "felbamate", "topamax", 
      "topiramate", "trileptal", "oxcarbazépine", "vimpat", "lacosamide", "zonegran", 
